...
<header>
    ...
    <div id="header-top-admin">
        <div id="header-top-inner-admin" class="flexbox container-medium">

            <div id="header-logo-div-admin">
                <div id="header-logo-admin">
                    <a href="index.php"><img src="images/logo.png" alt="Sports Warehouse Logo"></a>
                </div>
            </div>

            <div id="header-nav-admin">
                <ul id="main-menu">
                ...
                <div id="mobile-menu-admin" class="flexbox">
